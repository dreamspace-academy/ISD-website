    ...
    <div class="container">
        <div class="row">
            <div class="title-block">
                <h2 class="title text-cap">How does staging help</h2>
            ...
            <!-- End Title -->
            <p class="text-center">Home staging offers numerous benefits that can significantly impact the sale of a
                property. Here's how staging helps:</p>

            <div class="center bg-dark padding-top-20">
                <div class="accordion-process">
                    <div class="accordion-warp">
                        <div class="panel-group" id="accordion">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion"
                                            href="#FirstImpressions">01.First Impressions</a>
                                    </h4>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#FasterSales"
                                            class="collapsed">02.Faster Sales</a>
                                    </h4>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#HigherOffers"
                                            class="collapsed">03.Higher Offers</a>
                                    </h4>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#EmotionalConnection"
                                            class="collapsed">04.Emotional Connection</a>
                                    </h4>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#ShowcasePotential"
                                            class="collapsed">05.Showcase Potential</a>
                                    </h4>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#NeutralAppeal"
                                            class="collapsed">06.Neutral Appeal</a>
                                    </h4>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#MinimizedFlaws"
                                            class="collapsed">07.Minimized Flaws</a>
                                    </h4>
                                </div>
